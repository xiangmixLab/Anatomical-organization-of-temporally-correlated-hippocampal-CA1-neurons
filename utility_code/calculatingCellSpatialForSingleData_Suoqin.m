function [firingRateAll,countAll,countTimeAll,countTime,amplitudeAll,amplitude_rateAll,binInfo] = calculatingCellSpatialForSingleData_Suoqin(neuron,behavpos,behavtime,behavROI,binsize,segments,threshold,temp,intensity,plotting,countTimeThresh,small_velo)
%% Inputs:
