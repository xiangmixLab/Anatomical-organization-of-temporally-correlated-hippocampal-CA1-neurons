...
function [rateMap_corr_mean,rateMap_corr_all]=rateMap_PVec_correlation(fs1,fs2,ct1,ct2)
rateMap_corr=[];
...
rateMap_corr_mean=nanmean(rateMap_corr(:));
rateMap_corr_all=reshape(rateMap_corr,[],1)