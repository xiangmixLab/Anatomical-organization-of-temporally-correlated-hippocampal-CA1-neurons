function [infoPerSecond, infoPerSpike,pxO]=Doug_spatialInfo_021221(rm,occ,occThresh,Ro_in)
...
% here, occ is the countTime_pt, # of time points in each bin, adjust
% occThresh accordings
    ...
    %% Mutual information
    [MI, posterior, occupancy_map, prob_being_active, likelihood ] = extract_2D_information(nS, interp_behav_vec, X_bin_vector, Y_bin_vector, inclusion_vector)
