...
function [place_cells,all_infoScore,all_infoScore_norm] = permutingSpike_adapt_022220(neuron,behavpos,behavtime,temp,occThresh,binsize,small_velo,infosign)
...
% [firingrateAll]=adaptive_smoothing_firingrate(countAll,cpt,15);
...
%     [firingrateAllt]=adaptive_smoothing_firingrate(countAllt,cpt,15);
