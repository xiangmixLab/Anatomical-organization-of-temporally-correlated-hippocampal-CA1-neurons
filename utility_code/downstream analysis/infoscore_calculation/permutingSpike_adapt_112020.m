...
function [place_cells,all_infoScore,all_infoScore_norm] = permutingSpike_adapt_112020(neuron,behavpos,behavtime,temp,occThresh,binsize,small_velo,infosign)
...
[firingrateAll,countAll,~,countTime,~,~,~,cpt] = calculatingCellSpatialForSingleData_Suoqin(neuron,behavpos,behavtime,maxbehavROI,binsize,1:size(neuron.C,1),thresh,temp,[],[],countTimeThresh,small_velo);
