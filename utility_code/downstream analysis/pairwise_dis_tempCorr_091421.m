...
function [all_dis_corr_circle_all_intra,all_dis_corr_circle_all_inter,all_dis_corr_circle_all_all,midx,f,gof]=pairwise_dis_tempCorr_091421(foldername,cluster_file_name,session)
...
for k=1:length(foldername)
    ...
    for i=1:length(unique(group))
        ...
        dis_non_close_intra=all_dis_circle_intra{k,i}>35; % 35um distance
        ...
        dis_non_close_inter=all_dis_circle_inter{k,i}>35; % 35um distance
    ...
    dis_non_close_all=all_dis_circle_all{k}>35; % 35um distance
...
hold on;
h1=plot(f1,all_dis_corr_circle_all_intra(1:100:end,1),all_dis_corr_circle_all_intra(1:100:end,2));
% plot(all_dis_corr_circle_all_inter(1:50:end,1),all_dis_corr_circle_all_inter(1:50:end,2),'.','MarkerSize',15,'color','r');
h2=plot(f2,all_dis_corr_circle_all_inter(1:100:end,1),all_dis_corr_circle_all_inter(1:100:end,2));
h3=plot(f3);
