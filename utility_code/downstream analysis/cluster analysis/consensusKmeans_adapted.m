function CM = consensusKmeans_adapted(neuron0,threshCluster,K,N,time1,Fs)
...
%     idxx=ones(size(neuron0.C,2),1);
%     idxx1=randperm(size(neuron0.C,2));
%     idxx(idxx1(1:round(size(neuron0.C,2)*0.3)))=0; % randomly remove 30% of data
