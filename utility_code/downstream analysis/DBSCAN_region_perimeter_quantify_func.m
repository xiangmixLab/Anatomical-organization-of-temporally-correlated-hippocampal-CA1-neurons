function [avg_max_region,avg_max_peri,avg_max_region_95,avg_max_peri_95,area_thresh_all,max_regions,avg_max_region_nnum]=DBSCAN_region_perimeter_quantify_func(region_all,region_nnum_all,imageSize)
...
for i=1:size(region_all,1)
    for j=1:size(region_all,2)
        ...
        avg_max_region_nnum(i,j)=mean(avg_area_nnum);
        max_regions{i,j}=avg_area;
