...
function [A_color,A_color_region,avg_region_LT_tun,avg_region_shuf_LT_tun]=suppl17_cluster_region_cal(group_ori,dpath)
...
t1=tic;
for j=1:miceNum
    load([dpath{j},'\','neuronIndividuals_new_cleaned.mat'])
    for j1=1:trialNum
